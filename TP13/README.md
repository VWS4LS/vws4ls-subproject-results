...
Ein weiterer Fokus lag auf der Analyse und dem Vergleich von bereits etablierten Tool-Lösungen wie Eclipse BaSyx (siehe Abbildung 4-1), dem AAS-Designer sowie MNESTIX, um die Einsatzmöglichkeiten der Verwaltungsschale (VWS) in der industriellen Praxis zu bewerten und diese Tool-Lösungen weiterzuentwickeln. 
